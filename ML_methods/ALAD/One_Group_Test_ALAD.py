...
for i in range(NUM_GROUPS):
    ...
    group_df.to_csv(os.path.join(parent_directory, 'ML_methods','Reports_Methods', 'Reports_ALAD',
                                 DIR_EXP, 'csv_data', f'group_{i}.csv'),
                    index=False)
    scaled_group = get_scaled(group_df)
    group_list.append(scaled_group)
    save_scaler(scaled_group,
                os.path.join(parent_directory, 'ML_methods','Reports_Methods', 'Reports_ALAD',
...
for i, group_data in enumerate(group_list):
    ...
    output_dir = os.path.join(parent_directory, 'ML_methods','Reports_Methods', 'Reports_ALAD', DIR_EXP)
