...
for i, group_data in enumerate(group_list):
    ...
    #y_train_pred = pca_ad.fit(group_data)# csv_predict
    y_train_pred = pca_ad.fit_detect(group_data)

    y_train_scores = pca_ad.transform# csv_loss
    #y_train_scores_2 = pca  # csv_loss_ver_O_
    print()
